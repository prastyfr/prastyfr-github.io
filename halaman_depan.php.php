...
<html lang="en">
  ...
  <body>
    ...
    <a class="navbar-brand" href="#">
      ...
      <a href=""  style="margin-right: 700px; font-size: 15px; font-family: Source Sans Pro; color: white; text-decoration: none;">Konfirmasi Pembayaran</a>
       ...
       <img src="img/kai putih.png" style="margin-top: -12px; border: 4px solid; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;"></div>
          ...
          <div class="card-body"  style="background-color: #0b56a7; font-family: Source Sans Pro ; width: 345px; ">                
              <div class="form-group" >
                  ...
                  <option value=""><?= $st->nama_stasiun ?></option>
             ...
             <div class="form-group" >
              ...
              <a href=""><button class="btn text-white btn-block" style="background-color: #f08519; font-weight: bold; margin-top: 67px;" >Pesan & Cari Kereta</button></a>
